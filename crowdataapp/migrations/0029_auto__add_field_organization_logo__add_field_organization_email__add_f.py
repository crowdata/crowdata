...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'crowdataapp_organization', 'logo')

        # Deleting field 'Organization.email'
        db.delete_column(u'crowdataapp_organization', 'email')

        # Deleting field 'Organization.twitter'
        db.delete_column(u'crowdataapp_organization', 'twitter')

        # Deleting field 'Organization.facebook'
        db.delete_column(u'crowdataapp_organization', 'facebook')

        # Deleting field 'Organization.url'
        db.delete_column(u'crowdataapp_organization', 'url')
